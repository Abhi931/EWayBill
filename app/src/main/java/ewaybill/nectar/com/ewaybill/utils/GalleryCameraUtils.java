...
import static ewaybill.nectar.com.ewaybill.testSqlDatabase.TLoginActivity.context;
...
public static void pdf(Context con)
{
    ...
    ((Activity)con).startActivityForResult(Intent.createChooser(intent,"ChooseFile"), AppConstants.REQUEST_OPEN_DOCUMENTS_FOLDER);
}
    ...
    public static void openDocumentsFolder(Context context){
      ...
      /*  Intent intent = new Intent(context, FileChooser.class);
        ...
        ((Activity)context).startActivityForResult(Intent.createChooser(intent,"ChooseFile"), AppConstants.REQUEST_OPEN_DOCUMENTS_FOLDER);
