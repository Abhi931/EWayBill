...
public class UserSupplierRegistrationInteractorImpl implements Interactor {
  private static final String TAG = UserSupplierRegistrationInteractorImpl.class.getSimpleName();

  //gstin,name,email,mobileno,usertype,place,pincode,state
  @Override
  public void callApi(ApiInteractor apiInteractor, Object... args) {
      String title = (String)args[0];
      if(title.equalsIgnoreCase(AppConstants.SUPPLIER_REGISTRATION)) {
          callSupplierRegistrationAPI((String) args[1], (String) args[2], (String) args[3], (String) args[4], (String) args[5], (String) args[6]
 ...
 /* public void callLoginAPI(String name, String password, final ApiInteractor mListener) {
    ...
    public void callSupplierRegistrationAPI(String gstin, String name, String email,
                            String mobileno, String usertype, String place,String pincode, String state,String userid,final ApiInteractor mListener) {

      Call<JsonObject> call = EWayBillApplication.mRetroClient.callSupplierRegistrationAPI(gstin, name,email,
